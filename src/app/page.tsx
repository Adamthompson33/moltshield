...
// ═══════════════════════════════════════════════════════════════
// MOLTCOPS.COM — Landing Page v2
// ═══════════════════════════════════════════════════════════════
// ZERO FAKE DATA. Every number on this page must be real or absent.
// No hardcoded counters. No seeded metrics. No BASE_ constants.
// ═══════════════════════════════════════════════════════════════
...
const TIERS = [
  { name: "TRUSTED", score: "> 60", discount: "80% discount", color: "#22c55e", access: "Auto-approved" },
  { name: "CAUTION", score: "40–60", discount: "Standard pricing", color: "#ffc93e", access: "May require confirmation" },
...
const THREAT_CATEGORIES = [
  { name: "Drain Patterns", id: "PL-040", severity: "CRITICAL" },
  { name: "Sleeper Triggers", id: "PL-045", severity: "CRITICAL" },
  { name: "Unlimited Approvals", id: "PL-041", severity: "CRITICAL" },
  { name: "Key Export", id: "PL-001", severity: "CRITICAL" },
  { name: "Prompt Injection", id: "PL-060", severity: "HIGH" },
  { name: "Identity Spoofing", id: "PL-061", severity: "HIGH" },
  { name: "Code Injection", id: "PL-085", severity: "MEDIUM" },
  { name: "Data Exfiltration", id: "PL-081", severity: "MEDIUM" },
];
    ...
    >
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
          ...
          <div style={{ display: "flex", gap: 24, fontSize: 12, letterSpacing: 0.5 }}>
            {[
              ...
              <a
                ...
                onMouseEnter={(e) => (e.target.style.color = "#e2e4e9")}
        ...
        <Section>
          ...
          >
            {/* Urgency banner — real news, not fake metrics */}
            <div
              style={{
            ...
            >
              <span style={{ color: "#ff2b4e" }}>⚠</span>{" "}
              341 malicious skills found on ClawHub this week —{" "}
              <a
                href="/scan"
                style={{
                  color: "#ff2b4e",
            ...
            <div style={{ display: "flex", gap: 14, justifyContent: "center", flexWrap: "wrap" }}>
              <a
                ...
                onMouseEnter={(e) => {
                  ...
                  e.target.style.boxShadow = "0 8px 32px rgba(255,43,78,0.35)";
                }}
                onMouseLeave={(e) => {
                  e.target.style.transform = "translateY(0)";
                  e.target.style.boxShadow = "0 4px 24px rgba(255,43,78,0.25)";
                }}
              >
                Scan Your Code Free
              </a>
            ...
            {FEATURES.map((f, i) => (
              <Section key={f.title} delay={i * 0.1}>
                <a
                  ...
                  onMouseLeave={(e) => {
                    e.currentTarget.style.borderColor = "#151820";
        ...
        {/* ── TRUST TIERS ── */}
        <div id="trust" style={{ maxWidth: 1100, margin: "0 auto", padding: "40px 24px 80px" }}>
          <Section>
            <div
              style={{
                fontSize: 10,
            ...
            >
              ...
              <a
                ...
                style={{
                  ...
                  fontFamily: "'Anybody', system-ui, sans-serif",
                  color: "#ff2b4e",
                  border: "1px solid rgba(255,43,78,0.3)",
                  transition: "all 0.2s",
                }}
                onMouseEnter={(e) => {
                  e.target.style.background = "rgba(255,43,78,0.08)";
                  e.target.style.borderColor = "rgba(255,43,78,0.5)";
                }}
                onMouseLeave={(e) => {
                  e.target.style.background = "transparent";
                  e.target.style.borderColor = "rgba(255,43,78,0.3)";
                }}
              >
                Apply for Badge
              </a>
            ...
            {emailSubmitted ? (
              ...
              <div style={{ display: "flex", gap: 8, maxWidth: 400, margin: "0 auto" }}>
                <input
                  ...
                  onFocus={(e) => (e.target.style.borderColor = "#3b82f644")}
        ...
        >
          ...
          >
            <div>
              ...
              >
                You can't spell{" "}
                <b style={{ color: "#3a3d45" }}>M</b>olt
                <b style={{ color: "#3a3d45" }}>C</b>o
                <b style={{ color: "#3a3d45" }}>p</b>s without MCP.
              </div>
            </div>
            ...
            >
              {[
                ...
                <a
                  ...
                  onMouseEnter={(e) => (e.target.style.color = "#9ca0a9")}
          ...
          >
            © 2026 MoltCops. To Protect and Serve (Humanity).
          </div>
        </footer>
      </div>
